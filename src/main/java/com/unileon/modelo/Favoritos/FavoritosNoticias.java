 ...
 */
@Entity
@Table(name = "favoritosnoticias")
public class FavoritosNoticias implements Serializable {
    ...
    public int hashCode() {
        int hash = 7;
        hash = 37 * hash + this.idFavoritos;
        hash = 37 * hash + Objects.hashCode(this.Usuario);
        hash = 37 * hash + Objects.hashCode(this.Noticia);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final FavoritosNoticias other = (FavoritosNoticias) obj;
